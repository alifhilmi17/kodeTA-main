...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!rawActivityData) {
        ...
        activityData = [{
            ...
            text: "Catat jumlah telur harian",
            completed: false
        }, {
            text: "Periksa kesehatan ayam",
            completed: false
        }, {
            text: "Input laporan produksi",
            completed: false
        }];
    ...
    if (!rawAnnouncementData) {
        ...
        announcementData = [{
            text: "📌 Pembersihan kandang dilakukan setiap Senin & Kamis.",
            read: false
        }, {
            text: "📌 Vaksinasi ayam dilakukan pada 20 Oktober 2025.",
            read: false
        }, {
            text: "📌 Perawatan atap kandang dijadwalkan 25 Oktober 2025.",
            read: false
        }];
